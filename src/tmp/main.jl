...
function create_gui()
    ...
    function loadButton_clicked_callback(widget)
        ...
        filepath_slide =
            open_dialog("Pick an histological slide file",
                        GtkNullContainer(),
                        ("*.tif",
                         "*.png",
                         "*.jpg",
    ...
    function segmentationButton_clicked_callback(widget)
        ...
        JHistint.start_segmentation_SOPHYSM(filepath_to_segment,
                                            filepath_output,
                                            threshold_gray,
                                            threshold_marker)
    ...
    function simulationButton_clicked_callback(widget)
        ...
        filepath_file_JSPACE = replace(filepath_output,
                                       r"....$" => "_Files_JSpace")
        ...
        filepath_plot_JSPACE = replace(filepath_output,
                                       r"....$" => "_Plots_JSpace")
        ...
        Gtk.set_gtk_property!(Conf_t_10, :file,
                              joinpath(filepath_plot_JSPACE, "Conf_t_10.png"))
        Gtk.set_gtk_property!(Conf_t_20, :file,
                              joinpath(filepath_plot_JSPACE, "Conf_t_20.png"))
        Gtk.set_gtk_property!(Final_conf, :file,
                              joinpath(filepath_plot_JSPACE, "Final_conf.png"))
        Gtk.set_gtk_property!(driver_tree, :file,
                              joinpath(filepath_plot_JSPACE, "driver_tree.png"))
        ## gbox3[1,1] = Conf_t_10
        ## gbox3[1,2] = Conf_t_20
    ...
    Gtk.set_gtk_property!(thresholdGray_entry, :placeholder_text,
                          "Enter the threshold for the grayscale filter... (default 0.15)")
    Gtk.set_gtk_property!(thresholdMarker_entry, :placeholder_text,
                          "Enter the threshold to define the distance between the markers... (default -0.3)")
    ...
    ## main window setting
    main_win =
        GtkWindow("SOPHYSM - SOlid tumors PHYlogentic Spatial Modeller",
                  1000, 300)
    ...
    # Signals clicked
    id_1 = signal_connect(segmentationButton_clicked_callback,
                          segmentationButton,
                          "clicked")
    id_2 = signal_connect(simulationButton_clicked_callback,
                          simulationButton,
                          "clicked")
    id_3 = signal_connect(loadButton_clicked_callback,
                          loadButton,
                          "clicked")
end
