...
ApplicationWindow {
    ...
    function onSegmentationCompleted(imageName, outputs) {
        ...
        if (outputs.segmented)
            setSource(panelSegmented.imageItem, outputs.segmented);
        if (outputs.graphVertex)
            setSource(panelVertices.imageItem, outputs.graphVertex);
        if (outputs.graphEdges)
            setSource(panelGraph.imageItem, outputs.graphEdges);
        if (outputs.overlay)
            setSource(panelOverlay.imageItem, outputs.overlay);
        if (outputs.voronoi)
            setSource(panelVoronoi.imageItem, outputs.voronoi);
        for (var i = 0; i < projectImages.length; i++) {
            if (projectImages[i].name === imageName) {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    Label {
                        text: workspaceDir ? "📁 " + workspaceDir : "⚠ No workspace"
                        font.pixelSize: 9
                    ...
                    Button {
                        ...
                        background: Rectangle {
                            color: "transparent"
                            radius: 6
                            border.color: downloadButton.hovered ? (root.isDarkTheme ? "#666" : "#ccc") : "transparent"
                        }
                        ...
                        contentItem: Row {
                            ...
                            Image {
                                source: downloadButton.icon.source
                                width: downloadButton.icon.width
                                height: downloadButton.icon.height
                                ...
                                Repeater {
                                    ...
                                    Rectangle {
                                        ...
                                        RowLayout {
                                            ...
                                            Image {
                                                source: "img/check_circle_24dp.png"
                                                width: 16
                                                height: 16
                                                visible: modelData.hasOutput
                                            }
                ...
                ColumnLayout {
                    ...
                    Common.Button {
                        ...
                        onClicked: {
                            if (!currentImage || !segmentationMethod)
                                return;
                            ...
                            Julia.start_async_job(segmentationMethod, propmap.model_bson_path, currentImage, outputPath);
        ...
        Rectangle {
            ...
            GridLayout {
                ...
                Common.ImagePanel {
                    ...
                    Layout.fillWidth: true
                    Layout.fillHeight: true
                    onExpand: function (path, title) {
                        expandImage(path, title);
                    }
                }
                Common.ImagePanel {
                    id: panelSegmented
    ...
    Dialogs.Download {
        ...
        onDownloadCanceled: {
            Julia.log_message("@info", "Download canceled");
        }
    }
    Dialogs.Settings {
        id: settingsDialog
            ...
            Image {
                ...
                onStatusChanged: {
                    if (status === Image.Error) {
                        ...
                        console.log("✅ Image loaded:", expandedImage.source, "Size:", expandedImage.paintedWidth, "x", expandedImage.paintedHeight);
    ...
    function createProject(name) {
        if (!workspaceDir) {
            Julia.log_message("@error", "Set workspace first!");
            return;
        }
        ...
        projectImages = [];
        currentImage = "";
        Julia.log_message("@info", "Project created: " + projPath);
        updateWorkflowStep();
    }
